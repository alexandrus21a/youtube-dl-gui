...
class QueryManager {
    ...
    getUnifiedVideos(playlist, videos, audioOnly, selectedFormat, subtitles) {
        ...
        if (!playlist.audioOnly) {
            ...
            for (const video of videos) {
                ...
                video.audioQuality = (playlist.audioQuality != null) ? playlist.audioQuality : "best" || "320" || "192" || "160" || "128";
            }
        }
        playlist.audioQuality = (playlist.audioQuality != null) ? playlist.audioQuality : "best" || "320" || "192" || "160" || "128";
    }
    ...
    async querySize(video, formatLabel, format, audioOnly, videoOnly) {
        ...
        if (audioOnly) {
            if (formatLabel === "best" || "320" || "192" || "160" || "128") {
    ...
    getCachedSize(video, formatLabel, audioOnly, videoOnly) {
        if (audioOnly) {
            let applicableSize;
            if (formatLabel === "best" || "320" || "192" || "160" || "128") applicableSize = video.bestAudioSize;
